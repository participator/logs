(function(undefined) {
    ...
    /**
     * Class representing current year     
     */
    exports.CurrentYear = {
        /**
        ...
        /**
         * Applies the current year to the element given by query selector
         * @param {string} querySelector - The selector of the element to add the year to 
         */
        applyToPage(querySelector) {
            document.querySelector(querySelector).innerText = this.getYear();
        }
    };
